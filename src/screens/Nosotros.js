      ...
      <View style={styles.containerText}>
        ...
        <View>
          <Card style={styles.card}>
            ...
            <Text style={styles.item}>
              ...
              Inicial, la cual finalice, pero decidí hacer un cambio en mi vida
              y encontrar realmente a que quiero dedicarme. Actualmente me
              dedico a la programación, adquiriendo herramientas del área
              constantemente.
            </Text>
            <View style={styles.botones}>
              <ButtonGreenLight
        ...
        <View>
          <Card style={styles.card}>
            ...
            <Text style={styles.item}>
              Hola 👋🏽 ! soy Full stack web developer por lo que cuento con
              experiencia en Node.JS, React, Redux, JS, CSS. Ademas, cuento con
              experiencia previa en software de diseño gráfico, web y
              animación/modelado 3D (Figma, Illustrator, Sketch, Blender, Adobe
        ...
        <View>
          <Card style={styles.card}>
            ...
            <Text style={styles.item}>
              ...
              intercambio. En permanente capacitación y desarrollo profesional.
            </Text>
            <View style={styles.botones}>
              <ButtonGreenLight
                style={styles.link}
